...
class SplitScreenApp:
    def __init__(self, master):
        ...
        for position, frame in self.frames.items():
            if position == (0, 0):
                self.display_image(frame, r'C:\Users\Indrashis\Pictures\Saved Pictures\1.jpg')  # Replace "path_to_image.jpg" with your image path
            elif position == (0, 1):
                self.display_image(frame, r'C:\Users\Indrashis\Pictures\Saved Pictures\2.jpg')  # Replace "path_to_image.jpg" with your image path
            elif position == (1, 0):
                self.display_video(frame, r'C:\Users\Indrashis\Videos\Edit\ISRO\vdo2.mp4')  # Replace "path_to_video.mp4" with your video path
            elif position == (1, 1):
                self.display_video(frame, r'C:\Users\Indrashis\Videos\Edit\ISRO\vdo3.mp4')  # Replace "path_to_video.mp4" with your video path
